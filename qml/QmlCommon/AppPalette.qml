...
QtObject {
    ...
    readonly property color knob:           theme ? "#D1D1D1"      : (isDark ? "#E2E8F0" : "#FFFFFF")
    ...
    // ── Tooltip ───────────────────────────────────────────────────────────────
    readonly property color tooltipBg:     theme ? "#AARRGGBB"   : (isDark ? "#0B1220" : "#FFFFFF")
    readonly property color tooltipBorder: theme ? "#AARRGGBB"   : (isDark ? "#334155" : "#E2E8F0")
    readonly property color tooltipText:   theme ? "#F5F5F5"     : (isDark ? "#E2E8F0" : "#0F172A")
