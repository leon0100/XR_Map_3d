...
{
    qDebug() << "onPointCoordSpinBoxValueChanged............";
    if(!m_graphicsSceneView) return;
    ...
    item->setData(QString("x: %1, y: %2, z: %3").arg(coord.x()).arg(coord.y()).arg(coord.z()), Qt::DisplayRole);
...
{
    qDebug() << "onAddPolygonButtonClicked..............";
    if(!m_graphicsSceneView)
        return;
...
{
    qDebug() << "onPolygonColorDialogAccepted...............";
    if(!m_graphicsSceneView)
        return;
