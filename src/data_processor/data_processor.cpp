...
void DataProcessor::setSurfaceIsobathsPolygon(const QVariantList& points)
{
    ...
    QMetaObject::invokeMethod(worker_, "setSurfaceIsobathsPolygon", Qt::QueuedConnection, Q_ARG(QVariantList, points));
}

void DataProcessor::clearSurfaceIsobathsPolygon()
{
    QMetaObject::invokeMethod(worker_, "clearSurfaceIsobathsPolygon", Qt::QueuedConnection);
}
