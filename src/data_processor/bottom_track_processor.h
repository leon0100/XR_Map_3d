...
public:
    ...
    void bottomTrackProcessing_file(const DatasetChannel& channel1, const BottomTrackParam& bottomTrackParam_, bool manual, bool redrawAll); // external calling not realtime
